...
PokeApiPokemonResponsio pokeApiPokemonResponsioFromJson(String str) => PokeApiPokemonResponsio.fromJson(json.decode(str));

String pokeApiPokemonResponsioToJson(PokeApiPokemonResponsio data) => json.encode(data.toJson());
